...
<div class="row">
   <div class="col-sm-12">
   	   <div class="well">
   	   	   <center><h1 style="color: white;"><strong>Connectify_Me!</strong></h1></center>
   	   </div>
   </div>
</div>
<div class="row">
    ...
    if(isset($_POST['change']))
    {
    	...
    	if($pass == $pass1)
    	{
    		if(strlen($pass) >= 6 && strlen($pass) <= 60)
    		{
    			...
    			echo"<script>alert('Your Password wil be changed in a moment!')</script>";
    			echo"<script>window.open('home.php','_self')</script>";
    		}
    		else
    		{
    			echo"<script>alert('Your Password should be greater then 6 characters!')</script>";
    		}
    	}
    	else
    	{
    		echo"<script>alert('Your Password didnot match!')</script>";
