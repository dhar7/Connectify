...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;">Conectify</h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Join Connectify</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="input-group">
						...
						<input type="date" class="form-control input-md" placeholder="mm/dd/yyyy" name="u_birthday" required="required">
					</div><br>
