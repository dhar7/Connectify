...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: skyblue;text-align: center;left: 0.8%;border-radius: 5px;">
		<?php
		echo"
		...
		";
		?>
		<p><strong>Logged In: <?php echo $_COOKIE['app']; ?></strong><br>
	</div>
	<div class="col-sm-6">
		<?php
            global $con;
                ...
                if($content == 'No' && strlen($upload_image) >= 1)
                {
                 	...
                 	else
                 	{
                 		echo "
                               ...
                               <a href='single_delete.php?post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a>
